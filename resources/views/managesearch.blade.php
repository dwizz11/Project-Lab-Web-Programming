...
@foreach ($products as $products)
        <div class="container bg-white d-flex w-50 mt-3 mb-2" style="border-radius: 20px; box-shadow: 0px 0px 5px 5px rgba(0, 0, 0, 0.2); text-align: center; padding: 20px !important; margin-left: 0 !important; margin-right: 0 !important; position: relative; width: 60%">
