...
Route::post('/cart/purchase', [cartcontroller::class, 'purchasecartitems'])->middleware('auth');
Route::get('/checkcart', [cartcontroller::class, 'checkCart'])->middleware('auth');
...
Route::get('/checkhistory', [homecontroller::class , 'checkHistory'])->middleware('auth');
Route::get('/history', [homecontroller::class , 'showHistory'])->middleware('auth');
